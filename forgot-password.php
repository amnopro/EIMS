...
<head>
	...
	<title>Income And Expense - Forgot Password</title>
...
<body>
	<div class="row">
			<h2 align="center">Income And Expense </h2>
	<hr />
    ...
    echo $msg;
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="" name="submit" class="btn btn-danger">Reset</button><span style="padding-left:250px"><a href="index.php" class="btn btn-danger">Login</a></span>
