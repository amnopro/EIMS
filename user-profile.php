...
?>
							<form role="form" method="post" action="">
								<div class="form-group">
									...
									<input class="form-control" onkeypress="checkname(event)" type="text" value="<?php  echo $row['FullName'];?>" name="fullname" required="true">
								</div>
								<div class="form-group">
									<label>Email</label>
<input type="email" class="form-control" name="email" value="<?php  echo $row['Email'];?>" required="true" readonly="true">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php if(isset($row['MobileNumber']) && $row['MobileNumber'] != '')  echo $row['MobileNumber'];?>" required="true" name="contactnumber" maxlength="10" onkeypress="checkmobnumber(event)">
								</div>
								<div class="form-group">
