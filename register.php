    ...
    echo $msg;
						...
						<fieldset>
							<div class="form-group">
								<input class="form-control" onkeypress="checkusername(event)" placeholder="Full Name" name="name" type="text" required="true">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="E-mail" name="email" type="email" required="true">
							</div>
							<div class="form-group">
								<input type="number" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" maxlength="10" pattern="[0-9]" required="true" onkeypress="checkmobnumber(event)">
							</div>
							<div class="form-group">
